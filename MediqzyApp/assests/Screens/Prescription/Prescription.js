    ...
    return (
        <View style={styles.container}>
            ...
            <SafeAreaView style={styles.safeArea} edges={['top']}>
                ...
                {/* Toggle & Categories */}
                <View style={{ height: verticalScale(60), marginBottom: verticalScale(16) }}>
                ...
                <ScrollView style={styles.listContainer} showsVerticalScrollIndicator={false} contentContainerStyle={styles.listContent}>
                    {labs
                        ...
                        .map((lab) => (
                            <TouchableOpacity key={lab.id} style={styles.labCard} onPress={() => navigation.navigate('LabDetailsInfoScreen')}>
...
const styles = StyleSheet.create({
    ...
    labAddress: { fontSize: moderateScale(13), color: '#888' },
    phoneBtn: {
        width: scale(44),
        height: scale(44),
